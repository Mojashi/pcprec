...
fn main() {
    ...
    let pcp = PCP::parse_pcp_string("PCP(Vector(Tile(110,1), Tile(1,0), Tile(0,110)))");//hard
    ...
    let pcp = PCP::parse_pcp_string("PCP(Vector(Tile(1111,1110), Tile(0111,11), Tile(1,1101)))").reverse_pcp();
    // let idx = 31;
